          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-2">
            ...
            {!emailVerified && (
              <button
                ...
                disabled={isLoading}
                className="w-full sm:w-auto px-4 py-2 rounded-lg text-white font-semibold hover:scale-105 transition-all duration-300 text-sm whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed bg-[image:var(--cta3-green-gradient)] hover:bg-[image:var(--cta3-dark-hover-button)]"
              >
                {isLoading ? (
