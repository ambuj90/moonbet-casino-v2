...
const BrandSection = () => {
  ...
  return (
    <section className="w-full py-2 pb-8 relative">
          ...
          >
            {providers.map((provider, i) => (
              <motion.div
                ...
                className="trust_btn flex items-center justify-center w-full px-5 py-2 hover:bg-white/20  transition-all duration-300"
              >
                <img
                  src={provider.logo}
                  alt={provider.name}
