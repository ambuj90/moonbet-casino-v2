...
const ProvidersSection = () => {
  ...
  return (
    <section className="w-full py-2 md:py-6 relative">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <path
                ...
                fill="url(#paint0_linear_8959_12889)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_8959_12889"
                  x1="22.8571"
                  y1="25"
                  x2="9.64214"
                  y2="-3.90783"
          ...
          >
            {providers.map((provider, i) => (
              <motion.div
                ...
                className="trust_btn flex-shrink-0 w-[25%] sm:w-[140px] sm:h-[60px] h-[50px]  /20 rounded-lg flex items-center justify-center cursor-pointer hover:bg-white/5 transition-all duration-300"
              >
                <img
                  src={provider.logo}
                  alt={provider.name}
