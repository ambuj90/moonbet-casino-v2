...
const CryptoPaymentSection = () => {
  ...
  return (
    <section className="customborder-crypto w-full pt-6 px-4 md:flex hidden justify-center items-center">
      <motion.div
        ...
        <div className="flex sm:justify-start justify-center">
          <p className="flex items-center sm:text-2xl">
            <span
              ...
              style={{
                background:
                  "var(--icons-orange, linear-gradient(131deg, #FFB8A1 6.92%, #A62A00 121.35%))",
