...
const QuickPick = ({ iconSrc, label, active }) => (
  <button className={`h-[56px] rounded-xl flex flex-col items-center justify-center gap-1 text-[11px] ${glassBase} ${active ? glassActive : glassInactive}`}>
...
const GameTypeChip = ({ label, checked }) => (
  <button className={`min-w-[120px] px-4 py-2 rounded-xl flex items-center gap-2 text-sm ${glassBase} ${checked ? glassActive : glassInactive}`}>
...
const ThemeChip = ({ label, active }) => (
  <button className={`px-4 py-2 rounded-full text-sm ${glassBase} ${active ? glassActive : glassInactive} ${active ? "text-white" : "text-[#C9CBFF]"}`}>
    {label}
  </button>
);
...
const ProviderBtn = ({ text, active }) => (
  <button className={`px-4 py-2 rounded-xl flex items-center gap-2 text-xs ${glassBase} ${active ? glassActive : glassInactive} ${active ? "text-white" : "text-[#C9CBFF]"}`}>
            ...
            <div className="flex-1 overflow-y-auto px-5 space-y-6 pb-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <QuickPick iconSrc="/icons/trending.png" label="Trending" active />
