...
const AboutUs = () => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-[var(--bg-dark-purple-1)]">
      {/* Soft Background Glow */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -left-32 w-72 h-72 rounded-full blur-[120px] bg-[var(--cta-purple)]/10" />
        <div className="absolute -bottom-32 -right-32 w-72 h-72 rounded-full blur-[120px] bg-[var(--cta-pink)]/10" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 max-w-6xl">
        ...
        >
          ...
          <p className="text-[var(--text-lavender-2)] text-lg mt-3 font-light">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-14 rounded-2xl border border-white/10 bg-[var(--bg-dark-purple-2)]/50 backdrop-blur-xl p-8 shadow-lg"
        >
          <h2 className="text-2xl font-semibold text-white mb-4">
            What is Moonbet
          </h2>
          <p className="text-[var(--text-lavender-3)] text-[15px] leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-14">
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-2xl p-8 border border-white/10 bg-[var(--bg-dark-purple-2)]/40 hover:bg-white/[0.05] transition-all"
          >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-16 rounded-2xl p-10 border border-white/10 bg-[var(--bg-dark-purple-2)]/50 backdrop-blur-xl"
        >
          <h2 className="text-2xl text-white font-semibold mb-4">The Story</h2>
          <p className="text-[var(--text-lavender-3)] text-[15px] leading-relaxed mb-3">
          ...
          <p className="text-[var(--cta-pink)] font-semibold text-[16px]">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-2xl p-8 border border-white/10 bg-[var(--bg-dark-purple-2)]/40"
          >
            <h3 className="text-xl font-semibold mb-5">
              What Moonbet Stands For
            </h3>
            <ul className="space-y-2 text-[var(--text-lavender-3)] text-[15px]">
              {[
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mb-16 rounded-2xl p-10 border border-white/10 bg-[var(--bg-dark-purple-2)]/50"
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex gap-3">
                <span className="text-[var(--cta-pink)] text-lg">→</span>
                <span className="text-[var(--text-lavender-3)] text-[15px]">
                  {item}
                </span>
              </div>
            ))}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          className="mb-14 rounded-2xl p-8 border border-white/10 bg-[var(--bg-dark-purple-2)]/50 backdrop-blur-xl shadow-lg"
        >
          <h2 className="text-2xl font-semibold text-white mb-4">
            Moonbet refuses the industry shortcuts that treat users as numbers.
          </h2>

          <h3 className="text-white text-lg mb-2">Who runs Moonbet</h3>
          <p className="text-[var(--text-lavender-3)] leading-relaxed text-[15px]">
          ...
          <p className="text-[var(--cta-pink)]">x.com/thisisdjen</p>

          <h3 className="text-white text-lg mt-6 mb-2">How Moonbet is built</h3>
          <ul className="text-[var(--text-lavender-3)] text-[15px] leading-relaxed space-y-1">
          ...
          <h3 className="text-white text-lg mt-6 mb-2">The commitment</h3>
          <ul className="text-[var(--text-lavender-3)] text-[15px] leading-relaxed space-y-1">
          ...
          <h3 className="text-white text-lg mt-6 mb-2">
            The direction Moonbet wants to build:
          </h3>
          <ul className="text-[var(--text-lavender-3)] text-[15px] leading-relaxed space-y-1">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mb-20 bg-[var(--bg-dark-purple-2)]/50 border border-white/10 backdrop-blur-xl p-10 rounded-3xl text-center"
        >
          <h2 className="text-2xl text-white font-semibold mb-4">Socials</h2>
          <p className="text-[var(--text-lavender-3)] text-[15px] mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="text-[var(--cta-pink)] hover:text-white transition-colors text-[15px]"
            >
              x.com/moonbetgames
            </a>
